                                                    ...
                                                    const Eigen::Quaterniond &q_d)
{
  ...
  tf::quaternionEigenToMsg(q, qt);
  std::cout << qt.x << std::endl;
  std::cout << qt.y << std::endl;
  std::cout << qt.z << std::endl;
  std::cout << qt.w << std::endl;

  geometry_msgs::Quaternion qt_d;
  tf::quaternionEigenToMsg(q_d, qt_d);
  std::cout << "Target: " << std::endl;
  std::cout << qt_d.x << std::endl;
  std::cout << qt_d.y << std::endl;
  std::cout << qt_d.z << std::endl;
  std::cout << qt_d.w << std::endl;
